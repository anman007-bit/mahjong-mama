...
def _build_fortress_layout():
    """Раскладка КРЕПОСТЬ: 108 плиток = 54 пары.
    Стены по периметру + зубцы по углам + замок внутри + башня + макушка.
    Слой 0: 48 (стены крепости)
    ...
    # ===== СЛОЙ 0 - стены крепости (48 плиток) =====
    #              0123456789012345 6
    add_row(0, 0, 'XXXXXXXXXXXXXXXXX')   # верхняя стена (17)
    ...
    add_row(0, 6, 'XXXXXXXXXXXXXXXXX')   # нижняя стена (17)
